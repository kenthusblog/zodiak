...
let data = [
  {
    ...
    description:
      "Zodiak Capricorn mempunyai lambang kambing gunung, hewan yang terus menaiki gunung sampai puncak. Lambang kambing gunung dapat diartikan sebagai pekerja keras dan teguh pada keinginannya agar tercapai. Bagi Capricorn pencapaian adalah segalanya.<br/>Umum: Anda mesti tahu kapan mengatakan setuju atau ya terhadap pendapat dan pandangan orang dan kapan mesti menolak atau mengatakan tidak. Jika Anda tak sependapat, Anda mesti menunjukkannya dengan cara yang sopan dan enak dilihat. Alasannya, supaya relasi yang sudah Anda bangun selama ini tidak hancur karena sekeping egoisme atau sakit hati.",
  },
  {
    zodiac: "Aquarius",
    image: "https://kenthusblog.github.io/zodiak/images/Aquarius.jpg",
    description:
      "Aquarium tumpah adalah lambang dari zodiak Aquarius. Aquarium tumpah dapat diartikan sebagai orang yang dermawan dan mau merelakan waktunya untuk keluarga dan teman-temannya.<br/>Umum: Ada selingan baru dalam rutinitas. Bentuk atau wujudnya bisa bermacam-macam. Lihatlah selingan baru itu lebih sebagai kesempatan dan bukan sebagai gangguan. Justru hal itu bisa membantu Anda menjalankan tugas. Bukankah Anda semakin terpacu karena ada hal baru? Pada pertengahan pekan nanti, arahkan perhatian Anda kepada hal-hal yang kecil. Jangan mengabaikannya karena hal itu tetap punya hubungan dengan pekerjaan Anda.",
  },
  {
    zodiac: "Pisces",
    image: "https://kenthusblog.github.io/zodiak/images/Pisces.jpg",
    description:
      "Ikan merupakan lambang dari zodiak Pisces. Ikan dapat diartikan sebagai ketenangan. Oleh karena itu, Pisces selalu menjadi pendengar yang baik, berusaha memberikan ketenangan dan kesenangan pada orang yang sedang kesusahan.<br/>Umum : Anda rupanya suka sekali berkhayal tentang pekerjaan dan relasi Anda di awal pekan. Tak apa-apa! Yang penting, Anda bisa mengambil tindakan yang konkret sesuai dengan situasi dan/atau kondisi yang ada, jangan mengabaikan situasi yang sedang terjadi. Situasi itu bisa mendukung langkah Anda.",
  },
  {
    zodiac: "Aries",
  ...
  data.forEach((data) => {
    if (data.zodiac == valueZodiak) {
      document.getElementById("come").innerHTML = `
        <div class='note noteAlert'><h4>Zodiak Kamu <u>${data.zodiac}</h4> </u></div>
